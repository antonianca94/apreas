...
class APREAS_Plugin {
    ...
    private function enqueue_frontend_styles() {
        wp_enqueue_style('Participantes_CSS', plugins_url('/admin/css/participantes.css', __FILE__), array(), '1.0.24');
    ...
    private function enqueue_frontend_scripts() {
        ...
        wp_enqueue_script('Login_JS', plugins_url('/admin/js/login.js', __FILE__), array(), '1.0.43', true);
